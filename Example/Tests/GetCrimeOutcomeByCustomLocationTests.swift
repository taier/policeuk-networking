...
class GetCrimeOutcomeByCustomLocationTests: XCTestCaseBase {
  ...
  func testSuccessByPoly() {
    ...
    PoliceUKNetworking.getCrimeOutcomeByCustomLocation(forPoly: requestParamPoly,
  ...
  func testSuccessByLatitudeLongitude() {
    ...
    PoliceUKNetworking.getCrimeOutcomeByCustomLocation(forLatitude: requestParamLat,
