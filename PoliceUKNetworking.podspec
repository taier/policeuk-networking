...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PoliceUKNetworking.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Deniss Kaibagarovs/PoliceUKNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Deniss Kaibagarovs' => 'deniss.kaibagarovs@paymentsense.com' }
  s.source           = { :git => 'https://github.com/Deniss Kaibagarovs/PoliceUKNetworking.git', :tag => s.version.to_s }
